...
class OutputsPage():
	def __init__(self, master):
		...
		self.inputsHeadLabel.grid(row=0, column=0, pady=3)
		self.areaLabel.grid(row=1, column=0, pady=3)
		self.texturaLabel.grid(row=2, column=0, pady=3)
		self.transmissaoLabel.grid(row=3, column=0, pady=3)
		self.potenciaLabel.grid(row=4, column=0, pady=3)
		self.implementoLabel.grid(row=5, column=0, pady=3)
		self.larguraLabel.grid(row=6, column=0, pady=3)
		self.orgaoLabel.grid(row=7, column=0, pady=3)
		self.linhasLabel.grid(row=8, column=0, pady=3)
		self.velLabel.grid(row=9, column=0, pady=3)
		self.profLabel.grid(row=10, column=0, pady=3)
		self.passadaLabel.grid(row=11, column=0, pady=3)
		self.condSoloLabel.grid(row=12, column=0, pady=3)
		self.coefTransLabel.grid(row=13, column=0, pady=3)
		self.parALabel.grid(row=14, column=0, pady=3)
		self.parBLabel.grid(row=15, column=0, pady=3)
		self.parCLabel.grid(row=16, column=0, pady=3)
		self.parFLabel.grid(row=17, column=0, pady=3)
		self.rangeLabel.grid(row=18, column=0, pady=3)
		self.outputsHeadLabel.grid(row=0, column=1, pady=2)
		self.forcareqLabel.grid(row=1, column=1, pady=2)
		self.potreqBTLabel.grid(row=2, column=1, pady=2)
		self.potreqTDPLabel.grid(row=3, column=1, pady=2)
		self.potdispTDPLabel.grid(row=4, column=1, pady=2)
		self.fatorxLabel.grid(row=5, column=1, pady=2)
		self.combEspLabel.grid(row=6, column=1, pady=2)
		self.combHoraLabel.grid(row=7, column=1, pady=2)
		self.eficCampoLabel.grid(row=8, column=1, pady=2)
		self.capCampoTLabel.grid(row=9, column=1, pady=2)
		self.capCampoELabel.grid(row=10, column=1, pady=2)
		self.tempoLabel.grid(row=11, column=1, pady=2)
